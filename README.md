...
1. How would you describe acessibility on the web to someone new to programming?
    A: making sure your content's audience isnt exlusive

2. Talk about 3 different things you can do to ensure your website is accessible. 
    A:Creating websites that are semantically organized, using alt tags in proper places, and creating mobile friendly content 

3. How would you explain the concept of a variable to someone new to programming?
    A: similar to a variable in math. Its a placeholder for information that you can name whatever you want, and who's value "varies"....buh dum tsss

4. What is the purpose of using functions in code?
    A: to execute a desired action. 
